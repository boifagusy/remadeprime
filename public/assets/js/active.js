...
// ============================================
//  Author: Jay Flash
//  Author URL: https://twitter.com/jayflash01
// ============================================
...
var passWord2 = document.getElementById("password-visibility1");

if (passWord2) {
    passWord2.addEventListener('click', passwordFunction2);
}

function passwordFunction2() {
    var passInput = document.getElementById("psw-input1");
    passWord.classList.toggle("active");
...
var dataTablet2 = document.getElementById("dataTable2");
...
if (dataTablet2) {
    var dataTable2 = new DataTable(dataTablet2, {
        perPage: 10,
        perPageSelect: [10, 20, 30, 40, 50],
        searchable: true,
        sortable: false,
...
// Dark Mode
var toggleMode = document.getElementById("darkModeSwitch");
...
// disable button on clicked
var submitBtn = document.querySelectorAll(".btn-s");
for (var i = 0; i < submitBtn.length; i++) {
    // get parent form
    var parentFrm = submitBtn[i].closest('form');

    parentFrm.addEventListener("submit", function () {
        parentFrm.querySelector('.btn-s').disabled=true
    });
}
