            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span>Bill Settigs</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('admin.bills.airtime')}}">Airtime </a></li>
                        <li><a href="{{route('admin.bills.data')}}">Data Plans</a></li>
                        <li><a href="{{route('admin.bills.education')}}">Education </a></li>
                        <li><a href="{{route('admin.bills.cabletv')}}">Cable TV Plans</a></li>
                        <li><a href="{{route('admin.bills.electricity')}}">Electricity</a></li>
                        <li><a href="{{route('admin.bills.cards')}}">Recharge PINs</a></li>
                        <li><a href="{{route('admin.bills.swap')}}">Airtime to Cash</a></li>
                        {{-- <li><a href="{{route('admin.bills.bulksms')}}">Bulk SMS</a></li> --}}
                    </ul>
                </li>
                <li>
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="maps-google.html">Unread Tickets</a></li>
                        <li><a href="maps-vector.html">All Tickets</a></li>
                    </ul>
                </li> --}}
                <li>
