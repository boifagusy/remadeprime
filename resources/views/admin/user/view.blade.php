            ...
            <div class="card-body">                
                        ...
                        <div class="card outline-danger">
                            <div class="card-body">
                                ...
                                <div class="media-body text-start"> 
                                    ...
                                    <h4 class="mb-0 text-danger">{{ format_price($user->transactions->where('type',2)->sum('amount')) }}</h4>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="card outline-success">
                            <div class="card-body">
                                ...
                                <div class="media-body text-start">
                                    ...
                                    <h4 class="mb-0 text-success">{{ format_price($user->transactions->where('type',1)->sum('amount')) }}</h4>
                                </div>
                                {{-- <div class="align-self-center icon-lg">
                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="row">
                    ...
                    {{-- <div class="form-group col-md-6">
                        ...
                        <input type="text" placeholder="Balance" name="balance" class="form-control" value="{{$user->balance}}">
                    </div> --}}
                    <div class="form-group col-md-6">
