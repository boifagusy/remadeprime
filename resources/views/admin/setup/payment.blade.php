...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 fw-bold ">Strowallet Activation</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-9">
                        <label class="form-label">Enable Strowallet</label>
                    </div>
                    <div class="col-md-3">
                        <label class="jdv-switch jdv-switch-success mb-0">
                            <input type="checkbox" onchange="updateSystem(this, 'strowallet_payment')" @if(sys_setting('strowallet_payment') == 1) checked @endif>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
    ...
    <div class="col-sm-6 col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 fw-bold ">Strowallet Credentials</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('admin.setting.env_key') }}" method="POST">
                    @csrf
                    <input type="hidden" name="payment_method" value="strowallet">
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="STRO_PUBLIC_KEY">
                        <label class="form-label">{{__('PUBLIC KEY')}}</label>
                        <input type="text" class="form-control" name="STRO_PUBLIC_KEY" value="{{  env('STRO_PUBLIC_KEY') }}" placeholder="PUBLIC KEY" required>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="STRO_SECRET_KEY">
                        <label class="form-label">{{__('SECRET KEY')}}</label>
                        <input type="text" class="form-control" name="STRO_SECRET_KEY" value="{{  env('STRO_SECRET_KEY') }}" placeholder="SECRET KEY" required>
                    </div>
                    <div class="form-group mb-0 text-end">
