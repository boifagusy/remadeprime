    ...
    <table class="table table-bordered" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><p>{{$item->code}} </p> {{show_date($item->created_at)}} </td> 
                ...
                <td><a class="btn btn-sm btn-success" href="#" data-bs-toggle="modal" data-bs-target="#trxDetail{{$item->id}}" >View</a></td>
            </tr>
