...
<html lang="en">
  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container">
          ...
          <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
            <!-- Logo -->
            <div class="logo-wrapper"><a href="{{route('index')}}"><img src="{{my_asset(get_setting('logo'))}}" alt=""></a></div>
    ...
    {{-- content --}}
    <div class="page-content-wrapper d-flex align-items-center justify-content-center auth-bg">
        <div class="container">
            @yield('content')
        </div>
    </div>
